...
import { updateSession, addSession } from "@/src/store/slices/sessionsSlice";
import {
  createCourt,
  Court,
...
import { deepEqual } from "@/src/utils/util";
import { isNarrowScreen } from "@/src/utils/screenUtil";
import { validateSessionSize } from "@/src/utils/validation";
import { CourtManager } from "@/src/components/CourtManager";
import { SessionPlayerManager } from "@/src/components/SessionPlayerManager";
...
export default function EditSessionScreen() {
  ...
  // Get the session if we're editing
  ...
  const handleSave = () => {
    ...
    if (session) {
      dispatch(updateSession({ ...session, ...sessionData }));
            ...
            >
              ...
              >
                <View style={{ flexDirection: "column", flex: 1 }}>
                  ...
                  >
                    Use strict partnerships when deciding who sits out (partners
                    sit out as units)
                  </Text>
                </View>
                <Switch
